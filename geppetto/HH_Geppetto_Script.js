...
Simulation.addDynamicVisualization(hhcell.electrical, hhcell.electrical.SimulationTree.hhpop[0].v, GEPPETTO.setLocalRotationZ, function(x){return 6.28*(x+0.06)/0.06;});
